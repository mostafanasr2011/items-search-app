...
# ✨ 2. هندسة الـ CSS المتقدمة وتوحيد الخطوط والاتجاه RTL في كل التطبيق
st.markdown("""
    <style>
    ...
    /* إخفاء أيقونات المنصة وشريط الأدوات لشاشة نظيفة تماماً على الموبايل */
...
st.info("💡 نصيحة للموبايل: اضغط على السهم الصغير أعلى اليسار (إذا كان مخفياً) لفتح القائمة الجانبية والتنقل بين الصفحات.")
